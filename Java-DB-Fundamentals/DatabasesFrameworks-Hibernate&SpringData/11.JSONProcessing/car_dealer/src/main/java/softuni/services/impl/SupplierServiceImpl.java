...
public class SupplierServiceImpl implements SupplierService {
    ...
    @Override
    public void saveSupplierDto(SupplierImportJsonDto supplierImportJsonDto) {
        Supplier supplier = ModelParser.getInstance().map(supplierImportJsonDto,Supplier.class);
