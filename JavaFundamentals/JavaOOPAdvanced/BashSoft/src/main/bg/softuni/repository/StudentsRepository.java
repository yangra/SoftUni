...
import main.bg.softuni.repository.contracts.DataFilter;
...
public class StudentsRepository implements Database{
        ...
        for (int lineIndex = 0; lineIndex < lines.size(); lineIndex++) {
            ...
            if (!line.isEmpty() && matcher.find()) {
                ...
                try {
                    ...
                    students.putIfAbsent(studentName, new SoftUniStudent(studentName));
                    courses.putIfAbsent(courseName, new SoftUniCourse(courseName));
    ...
    public SimpleOrderedBag<Course> getAllCoursesSorted(Comparator<Course> cmp) {
        SimpleOrderedBag<Course> courseSortedList =
    ...
    public SimpleOrderedBag<Student> getAllStudentsSorted(Comparator<Student> cmp) {
        SimpleOrderedBag<Student> studentSortedList =
